# -*- coding: utf-8 -*-
"""ECE421 A3 2.2.3 K-Means

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17THBEW6q3O_vVcF_204u47kGXwx2LuoD
"""
...
with tf.Session() as training_loop:
  ...
  for epoch in range(150):
    ...
    if is_valid:
      ...
      valid_loss = training_loop.run(v_loss) # Validation distance.
      validation_loss.append(valid_loss/len(val_data)) # Updates validation loss and distances.
...
with tf.Session() as get_loss:
  ...
  valid_dist = get_loss.run(v_dist)
